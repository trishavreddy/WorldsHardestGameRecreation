...
public class Level1 extends JPanel implements KeyListener,Runnable
{
	...
	public Level1()
	{
		...
		int c5y = 327;
		gameOn=true;
		r1 = new Rectangle(x,y,28,28);
		r2 = new Rectangle(x,y,31,31);
		...
		t.start();
		int fails = 0;
		int polyX[] = {70, 190, 190, 230, 230, 510, 510, 710, 710, 590, 590, 550, 550, 270, 270, 70};
		int polyY[] = {120, 120, 360, 360, 160, 160, 120, 120, 400, 400, 160, 160, 360, 360, 400, 400};
		poly = new Polygon(polyX, polyY, 16);
	}
	public void paintComponent(Graphics g)
	{
		...
		g2d.setFont(f);
		g2d.drawString("LEVEL: 1",10,30);
		g2d.drawString(failsText,630,30);

		//boxes
		g2d.setColor(boxGreen);
		g2d.fillRect(70,120,120,280);
		g2d.fillRect(590,120,120,280);

		//main box
		g2d.setColor(whiteSquare);
		g2d.fillRect(230,160,320,200);
	...
	public void run()
	{
		...
		while(true)
		{
			if(gameOn)
			{
				...
				Rectangle r = new Rectangle(x+vx-2,y+vy-2,32,32);
				if(poly.contains(r))
				{
					x += vx;
					y += vy;
